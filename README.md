...
A full-stack application that analyzes resumes against job descriptions using AI (Groq LLaMA), providing match scores, skill gap analysis, and career roadmaps.
